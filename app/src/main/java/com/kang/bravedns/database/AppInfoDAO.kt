...
import com.kang.bravedns.data.DataUsage
...
interface AppInfoDAO {
    ...
    @Query("update AppInfo set isProxyExcluded = :bypass where packageName = 'com.kang.bravedns'")
    fun setRethinkToBypassProxy(bypass: Boolean)

    @Query("update AppInfo set firewallStatus = 7 and connectionStatus = 3 where packageName = 'com.kang.bravedns'")
