...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_27_28: Migration =
            object : Migration(27, 28) {
                override fun migrate(db: SupportSQLiteDatabase) {
                    db.execSQL(
                        "CREATE TABLE IF NOT EXISTS 'HostsProfile' ('id' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, 'name' TEXT NOT NULL, 'enabled' INTEGER NOT NULL, 'priority' INTEGER NOT NULL, 'sourceType' TEXT NOT NULL, 'updatedAt' INTEGER NOT NULL)"
                    )
                    db.execSQL(
                        "CREATE TABLE IF NOT EXISTS 'HostsEntry' ('id' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, 'profileId' INTEGER NOT NULL, 'domain' TEXT NOT NULL, 'recordType' TEXT NOT NULL, 'value' TEXT NOT NULL, 'enabled' INTEGER NOT NULL, 'isSuffixMatch' INTEGER NOT NULL, 'source' TEXT NOT NULL, 'updatedAt' INTEGER NOT NULL)"
                    )
                    db.execSQL(
                        "CREATE INDEX IF NOT EXISTS 'index_HostsEntry_profileId_domain_recordType' ON 'HostsEntry' ('profileId', 'domain', 'recordType')"
                    )
                    db.execSQL(
                        "CREATE TABLE IF NOT EXISTS 'HostsProfileSync' ('profileId' INTEGER NOT NULL, 'remoteUrl' TEXT NOT NULL, 'etag' TEXT NOT NULL, 'contentHash' TEXT NOT NULL, 'lastSuccessTs' INTEGER NOT NULL, 'lastError' TEXT NOT NULL, 'updatedAt' INTEGER NOT NULL, PRIMARY KEY('profileId'))"
                    )
                    db.execSQL(
                        "INSERT OR IGNORE INTO HostsProfile(name, enabled, priority, sourceType, updatedAt) VALUES('Default', 1, 0, 'manual', 0)"
                    )
                }
            }
    ...
    abstract fun hostsProfileDao(): HostsProfileDao

    abstract fun hostsEntryDao(): HostsEntryDao

    abstract fun hostsProfileSyncDao(): HostsProfileSyncDao
    ...
    fun hostsProfileRepository() =
        HostsProfileRepository(hostsProfileDao(), hostsEntryDao(), hostsProfileSyncDao())
