...
import com.kang.bravedns.util.Constants.Companion.INVALID_PORT
...
class PersistentState(context: Context) : SimpleKrate(context), KoinComponent {
    ...
    /**
     * When true, local hosts/profiles are consulted first; misses use [dnsType] upstream.
     * Independent of [dnsType] (no longer modeled as [AppConfig.DnsType.LOCAL_HOSTS]).
     */
    var localDnsLayerEnabled by booleanPref("local_dns_layer_enabled").withDefault(false)
