...
object DatabaseModule {
    ...
    private val daoModule = module {
        ...
        single { get<AppDatabase>().hostsProfileDao() }
        single { get<AppDatabase>().hostsEntryDao() }
        single { get<AppDatabase>().hostsProfileSyncDao() }
    ...
    private val repositoryModule = module {
        ...
        single { get<AppDatabase>().subscriptionStateHistoryDao() }
        single { get<AppDatabase>().hostsProfileRepository() }
