 ...
 */
package com.kang.bravedns.wireguard

import Logger
import Logger.LOG_TAG_PROXY
import com.kang.bravedns.database.WgHopMap
import com.kang.bravedns.database.WgHopMapRepository
...
typealias WgConfig = com.kang.bravedns.wireguard.Config
    ...
    fun setUp() {
        ...
        startKoin {
            modules(module {
                ...
                single { mockk<com.kang.bravedns.database.AppDatabase>(relaxed = true) }
            })
        }
