...
import com.kang.bravedns.adapter.LocalAdvancedViewAdapter
import com.kang.bravedns.adapter.LocalSimpleViewAdapter
import com.kang.bravedns.adapter.RemoteAdvancedViewAdapter
import com.kang.bravedns.adapter.RemoteSimpleViewAdapter
import com.kang.bravedns.customdownloader.LocalBlocklistCoordinator.Companion.CUSTOM_DOWNLOAD
import com.kang.bravedns.data.AppConfig
import com.kang.bravedns.data.FileTag
import com.kang.bravedns.databinding.FragmentRethinkBlocklistBinding
import com.kang.bravedns.download.AppDownloadManager
import com.kang.bravedns.download.DownloadConstants.Companion.DOWNLOAD_TAG
import com.kang.bravedns.download.DownloadConstants.Companion.FILE_TAG
import com.kang.bravedns.service.PersistentState
import com.kang.bravedns.service.RethinkBlocklistManager
import com.kang.bravedns.service.RethinkBlocklistManager.RethinkBlocklistType.Companion.getType
import com.kang.bravedns.service.RethinkBlocklistManager.getStamp
import com.kang.bravedns.service.RethinkBlocklistManager.getTagsFromStamp
...
import com.kang.bravedns.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_TYPE
import com.kang.bravedns.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_URL
import com.kang.bravedns.ui.bottomsheet.RethinkPlusFilterBottomSheet
import com.kang.bravedns.util.Constants
import com.kang.bravedns.util.Constants.Companion.DEAD_PACK
import com.kang.bravedns.util.Constants.Companion.DEFAULT_RDNS_REMOTE_DNS_NAMES
import com.kang.bravedns.util.Constants.Companion.MAX_ENDPOINT
import com.kang.bravedns.util.Constants.Companion.RETHINK_STAMP_VERSION
import com.kang.bravedns.util.CustomLinearLayoutManager
import com.kang.bravedns.util.UIUtils
import com.kang.bravedns.util.UIUtils.fetchToggleBtnColors
import com.kang.bravedns.util.UIUtils.htmlToSpannedText
import com.kang.bravedns.util.Utilities.getRemoteBlocklistStamp
import com.kang.bravedns.util.Utilities.hasLocalBlocklists
import com.kang.bravedns.util.Utilities.hasRemoteBlocklists
import com.kang.bravedns.util.Utilities.showToastUiCentered
import com.kang.bravedns.viewmodel.LocalBlocklistPacksMapViewModel
import com.kang.bravedns.viewmodel.RemoteBlocklistPacksMapViewModel
import com.kang.bravedns.viewmodel.RethinkLocalFileTagViewModel
import com.kang.bravedns.viewmodel.RethinkRemoteFileTagViewModel
