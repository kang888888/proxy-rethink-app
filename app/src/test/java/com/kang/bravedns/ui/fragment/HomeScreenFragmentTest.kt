...
@Config(
    sdk = [28],
    shadows = [com.kang.bravedns.shadows.ShadowRouterStats::class]
)
class HomeScreenFragmentTest : KoinTest {
    ...
    fun setUp() {
        ...
        try {
            ...
            mockkStatic("com.kang.bravedns.util.UIUtils")
            mockkStatic("com.kang.bravedns.util.Utilities")
            mockkStatic("com.kang.bravedns.scheduler.WorkScheduler")
        ...
        org.koin.core.context.startKoin {
            modules(
                module {
                    ...
                    single { mockk<com.kang.bravedns.database.AppInfoRepository>(relaxed = true) }
                    single { mockk<com.kang.bravedns.database.CustomDomainRepository>(relaxed = true) }
                    single { mockk<com.kang.bravedns.database.CustomIpRepository>(relaxed = true) }
                    single { mockk<com.kang.bravedns.database.WgConfigFilesRepository>(relaxed = true) }
                    single { mockk<com.kang.bravedns.database.ProxyEndpointRepository>(relaxed = true) }
                    single { mockk<com.kang.bravedns.database.DnsLogRepository>(relaxed = true) }
                    single { mockk<com.kang.bravedns.database.ConnectionTrackerRepository>(relaxed = true) }
