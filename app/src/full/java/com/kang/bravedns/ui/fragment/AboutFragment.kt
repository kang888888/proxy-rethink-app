...
import com.kang.bravedns.database.AppDatabase
import com.kang.bravedns.databinding.DialogInfoRulesLayoutBinding
import com.kang.bravedns.databinding.DialogWhatsnewBinding
import com.kang.bravedns.databinding.FragmentAboutBinding
import com.kang.bravedns.scheduler.BugReportZipper
import com.kang.bravedns.scheduler.BugReportZipper.getZipFileName
...
import com.kang.bravedns.ui.HomeScreenActivity
import com.kang.bravedns.ui.bottomsheet.BugReportFilesBottomSheet
...
import com.kang.bravedns.util.Constants.Companion.TIME_FORMAT_4
import com.kang.bravedns.util.FirebaseErrorReporting.TOKEN_LENGTH
import com.kang.bravedns.util.KernelProc
...
import com.kang.bravedns.util.UIUtils.openAppInfo
import com.kang.bravedns.util.UIUtils.openUrl
import com.kang.bravedns.util.UIUtils.openVpnProfile
import com.kang.bravedns.util.UIUtils.sendEmailIntent
...
import com.kang.bravedns.util.disableFrostTemporarily
import com.kang.bravedns.util.restoreFrost
...
class AboutFragment : Fragment(R.layout.fragment_about), View.OnClickListener, KoinComponent {
    ...
    private fun openEventLogs() {
        val intent = Intent(requireContext(), com.kang.bravedns.ui.activity.EventsActivity::class.java)
