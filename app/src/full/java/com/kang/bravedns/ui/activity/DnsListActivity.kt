...
import com.kang.bravedns.databinding.ActivityOtherDnsListBinding
...
class DnsListActivity : AppCompatActivity(R.layout.activity_other_dns_list) {
    ...
    private fun setupClickListeners() {
        b.btnLocalHostsProfiles.setOnClickListener {
            startActivity(Intent(this, LocalHostsProfilesActivity::class.java))
        }
    ...
    private fun highlightSelectedUi(working: Boolean) {
        ...
        if (appConfig.isLocalHostsEnabled()) {
            b.btnLocalHostsProfiles.strokeColor = ColorStateList.valueOf(strokeColor)
            b.btnLocalHostsProfiles.strokeWidth = 2
            b.btnLocalHostsProfiles.setTextColor(textColor)
        } else {
            b.btnLocalHostsProfiles.strokeWidth = 0
        }
    }
