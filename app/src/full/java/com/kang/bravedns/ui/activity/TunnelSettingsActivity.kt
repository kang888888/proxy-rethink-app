...
import com.kang.bravedns.databinding.ActivityTunnelSettingsBinding
...
import com.kang.bravedns.ui.dialog.NetworkReachabilityDialog
...
class TunnelSettingsActivity : AppCompatActivity(R.layout.activity_tunnel_settings) {
    ...
    private fun openCustomLanIpDialog() {
        try {
            ...
            val dialog = com.kang.bravedns.ui.dialog.CustomLanIpDialog(
                this,
                persistentState,
                themeId
            )
